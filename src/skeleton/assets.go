...
var _Assets5841fe69aac7e8cca07b6fec419b45acbd0ee4ce = "variable \"vpc-{{ .Project }}-public-subnets\" {\n  type = list(string)\n}\n\nvariable \"sg-{{ .Project }}-rds-ids\" {\n  type = list(string)\n}\n"
...
var Assets = assets.NewFileSystem(map[string][]string{"/": []string{"resource"}, "/resource": []string{}, "/resource/tmpl": []string{}, "/resource/tmpl/terraform": []string{}, "/resource/tmpl/terraform/modules": []string{}, "/resource/tmpl/terraform/modules/alb": []string{"variables.tf.tmpl", "api.tf.tmpl", "main.tf.tmpl", "variables-elements.tmpl"}, "/resource/tmpl/terraform/modules/ecr": []string{"policy.json.tmpl", "api.tf.tmpl"}, "/resource/tmpl/terraform/modules/ecs": []string{"outputs.tf.tmpl", "main.tf.tmpl"}, "/resource/tmpl/terraform/modules/iam": []string{"ecs.tf.tmpl"}, "/resource/tmpl/terraform/modules/rds": []string{"replica.tf.tmpl", "variables.tf.tmpl", "main.tf.tmpl"}, "/resource/tmpl/terraform/modules/sg": []string{"outputs.tf.tmpl", "variables.tf.tmpl", "main.tf.tmpl"}, "/resource/tmpl/terraform/modules/vpc": []string{"outputs.tf.tmpl", "variables.tf.tmpl", "main.tf.tmpl"}, "/resource/tmpl/terraform/regions": []string{".gitignore.tmpl", "aws.tf.tmpl", "backend.tf.tmpl", "modules.tf.tmpl", "variables.tf.tmpl"}}, map[string]*assets.File{
	"/resource/tmpl/terraform/modules/iam/ecs.tf.tmpl": &assets.File{
	...
	}, "/resource/tmpl/terraform/modules/rds/main.tf.tmpl": &assets.File{
		Path:     "/resource/tmpl/terraform/modules/rds/main.tf.tmpl",
		FileMode: 0x1a4,
		Mtime:    time.Unix(1581269961, 1581269961999000000),
		Data:     []byte(_Assetsbb54e51293053469b10a2bb07d69384dbbac293b),
		...
		FileMode: 0x800001ed,
		Mtime:    time.Unix(1581268756, 1581268756076267679),
		Data:     nil,
	}, "/resource/tmpl/terraform/modules/alb": &assets.File{
		Path:     "/resource/tmpl/terraform/modules/alb",
		FileMode: 0x800001ed,
		Mtime:    time.Unix(1581270535, 1581270535050916326),
		Data:     nil,
	...
	}, "/resource/tmpl/terraform/modules/alb/variables-elements.tmpl": &assets.File{
		Path:     "/resource/tmpl/terraform/modules/alb/variables-elements.tmpl",
		FileMode: 0x1a4,
		Mtime:    time.Unix(1581270535, 1581270535051559726),
		Data:     []byte(_Assets6a0526989514755393975b12afd4c6689fa7bf97),
		...
		FileMode: 0x800001ed,
		Mtime:    time.Unix(1581268756, 1581268756078627679),
		Data:     nil,
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1581270385, 1581270385958949406),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1581268756, 1581268756077920177),
		Data:     []byte(_Assets3ff5abfa5c08898738456203761e92760f43576f),
	}, "/resource/tmpl/terraform/modules/rds/replica.tf.tmpl": &assets.File{
		Path:     "/resource/tmpl/terraform/modules/rds/replica.tf.tmpl",
		FileMode: 0x1a4,
		Mtime:    time.Unix(1581269230, 1581269230782000000),
		Data:     []byte(_Assets5d49b890a77621c0cda3e6c990fa63f1d8c49569),
	...
	}, "/resource/tmpl/terraform/modules/rds": &assets.File{
		Path:     "/resource/tmpl/terraform/modules/rds",
		FileMode: 0x800001ed,
		Mtime:    time.Unix(1581269961, 1581269961998439554),
		Data:     nil,
	...
	}, "/resource/tmpl/terraform/modules/rds/variables.tf.tmpl": &assets.File{
		Path:     "/resource/tmpl/terraform/modules/rds/variables.tf.tmpl",
		FileMode: 0x1a4,
		Mtime:    time.Unix(1581268756, 1581268756077270027),
		Data:     []byte(_Assets5841fe69aac7e8cca07b6fec419b45acbd0ee4ce),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1581268756, 1581268756078406408),
		...
		FileMode: 0x800001ed,
		Mtime:    time.Unix(1581268756, 1581268756078237361),
		Data:     nil,
		...
		Path:     "/",
		FileMode: 0x800001ed,
		Mtime:    time.Unix(1581270546, 1581270546728038293),
		Data:     nil,
