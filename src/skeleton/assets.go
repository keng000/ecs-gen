...
var _Assets949f1ec398d11b3847420f5ac22babc0ac75614b = "variable \"load_balancer_rule\" {\n  type = \"map\"\n  default = {\n      {{ .lbRule }}\n  }\n}"
...
var Assets = assets.NewFileSystem(map[string][]string{"/": []string{"resource"}, "/resource": []string{}, "/resource/tmpl": []string{}, "/resource/tmpl/terraform": []string{}, "/resource/tmpl/terraform/modules": []string{}, "/resource/tmpl/terraform/modules/alb": []string{"variables.tf.tmpl", "api.tf.tmpl", "main.tf.tmpl"}, "/resource/tmpl/terraform/modules/ecr": []string{"policy.json.tmpl", "api.tf.tmpl"}, "/resource/tmpl/terraform/modules/ecs": []string{"outputs.tf.tmpl", "main.tf.tmpl"}, "/resource/tmpl/terraform/modules/iam": []string{"ecs.tf.tmpl"}, "/resource/tmpl/terraform/modules/sg": []string{"outputs.tf.tmpl", "variables.tf.tmpl", "main.tf.tmpl"}, "/resource/tmpl/terraform/modules/vpc": []string{"outputs.tf.tmpl", "main.tf.tmpl"}, "/resource/tmpl/terraform/regions": []string{".gitignore.tmpl", "aws.tf.tmpl", "backend.tf.tmpl", "modules.tf.tmpl", "variables.tf.tmpl"}}, map[string]*assets.File{
	"/": &assets.File{
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1579935670, 1579935670217861189),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1579935670, 1579935670221652616),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1579936424, 1579936424342908291),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1579935670, 1579935670218885348),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1579935670, 1579935670221286924),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1579935609, 1579935609591027325),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1579936079, 1579936079485057806),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1579935670, 1579935670218227427),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1579935670, 1579935670220829972),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1579935670, 1579935670221890962),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1579935670, 1579935670219439008),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1579935670, 1579935670220205968),
